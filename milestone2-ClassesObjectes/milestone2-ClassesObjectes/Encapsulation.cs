...
namespace milestone2
{
    ...
    class Encapsulation
    {
        static void Main5()
        {
            ...
            Product1 product = new Product1("Laptop", 95.50);
            ...
            Users user = new Users("Gayathri", "Gayathri.mohandoss@ust.com", "Password123");
            Console.WriteLine($"User: {user.Username}, Email: {user.Email}");

            user.UpdateDetails("Gayathri_123", "Gayathri.m@ust.com", "pass123456");
